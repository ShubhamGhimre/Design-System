...
export interface LoginFullBleedProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'onSubmit'> {
...
export function LoginFullBleed({
  className,
  onSubmit,
  onToggleMode,
  brandSlot,
  ...
  return (
    <div
      className={cn(
        ...
        bgImage ? 'bg-cover bg-center' : 'bg-gradient-to-br from-primary/30 via-background to-primary/10',
        className,
      )}
    ...
    >
      ...
      <Card className="relative z-10 w-full max-w-md border-border/50 bg-background/95 p-8 shadow-xl backdrop-blur">
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          <div className="space-y-2">
            <Label htmlFor="fullbleed-email">Email</Label>
            <Input
              id="fullbleed-email"
              type="email"
          ...
          <div className="space-y-2">
            <Label htmlFor="fullbleed-password">Password</Label>
            <div className="relative">
              <Input
                id="fullbleed-password"
