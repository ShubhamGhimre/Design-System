...
export interface LoginCenteredProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'onSubmit'> {
      ...
      <Card className="w-full max-w-md p-8">
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          <div className="space-y-2">
            ...
            />
            {fieldErrors.email ? <p id="login-email-error" className="text-xs text-destructive">{fieldErrors.email}</p> : null}
          </div>
          ...
          <div className="space-y-2">
            ...
            {fieldErrors.password ? <p id="login-password-error" className="text-xs text-destructive">{fieldErrors.password}</p> : null}
          </div>
        ...
        {onToggleMode ? (
          <p className="mt-6 text-center text-sm text-muted-foreground">
            ...
            <button type="button" onClick={onToggleMode} className="font-medium text-primary underline-offset-4 hover:underline">
              Sign up
            </button>
          </p>
        ) : null}
